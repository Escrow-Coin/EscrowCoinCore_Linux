...
{
	resize(900, 520);
	setWindowTitle(tr("Escrow") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
	setObjectName("Escrow");
	setStyleSheet("#Escrow { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a Escrow address"));
	...
	aboutAction = new QAction(QIcon(":icons/bitcoin"), tr("&About Escrow"), this);
	aboutAction->setToolTip(tr("Show information about Escrow"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for Escrow"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #000000; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #adc8ce; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #adc8ce; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #adc8ce; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"#tabs { color: #000000; background-color: #11b6d6; border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("Escrow client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("Escrow client"));
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Escrow network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Escrow address or malformed URI parameters."));
	}
