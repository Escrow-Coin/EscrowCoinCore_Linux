...
private slots:
    ...
    QString BuyESCO(QString OrderType, double Quantity, double Rate);
    QString SellESCO(QString OrderType, double Quantity, double Rate);
